...
This is Part 2 (Evaluation) of a 3-part series.
Reading: [[file:../../../2025/11/15/lisp-1.org][Part 1 (Parsing)]] | [[file:../../../2026/02/21/lisp-3.org][Part 3 (Lambdas)]]
...
#[test]
fn eval_function_literal_returns_function() {
...
#+BEGIN_SRC rust
#[test]
fn eval_variable_returns_value_referenced_by_variable() {
    assert_eq!(
...
#[test]
fn function_call_expression_evaluates_function() {
...
Tada 🥳! We have a basic interpreter that is relatively powerful despite the
...
#+BEGIN_SRC rust
#[test]
fn if_statement_only_executes_single_branch() {
...
#+BEGIN_SRC rust
#[test]
fn define_sets_variable_reference() {
    let mut env = Environment::default().with_value("+", Val::Function(add));
...
#+BEGIN_SRC rust
#[test]
fn define_with_expression_assigns_result_of_expression_to_variable() {
    let mut env = Environment::default().with_value("+", Val::Function(add));
...
programs. In [[file:../../02/21/lisp-3.org][Part 3]], we'll add user-defined functions with ~lambda~.
