...
# DESIGN.md palette: bar fill #4078f2 (accent blue), text/axes #333
set style fill solid 0.85 border rgb '#333'
set boxwidth 0.6
set yrange [0:0.07]
set ylabel "microseconds" textcolor rgb '#333'
set title "add(1+2, 3+4) benchmark" textcolor rgb '#333'
set key off
set xtics rotate by -20 textcolor rgb '#333'
set ytics textcolor rgb '#333'
set border 11 lw 1.5 lc rgb '#333'
set style line 1 lc rgb '#4078f2'
...
set yrange [0:15]
set ylabel "microseconds" textcolor rgb '#333'
set title "fib(12) benchmark" textcolor rgb '#333'
set key off
set xtics rotate by -20 textcolor rgb '#333'
set ytics textcolor rgb '#333'
set border 11 lw 1.5 lc rgb '#333'
