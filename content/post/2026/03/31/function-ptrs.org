...
# Site palette: warm accent #cb6e21, cool accent #28728b, heading #663894.
set style fill solid 0.85 border rgb '#222'
set boxwidth 0.6
set yrange [0:0.07]
set ylabel "microseconds" textcolor rgb '#222'
set title "add(1+2, 3+4) benchmark" textcolor rgb '#222'
set key off
set xtics rotate by -20 textcolor rgb '#222'
set ytics textcolor rgb '#222'
set border 11 lw 1.5 lc rgb '#444'
set style line 1 lc rgb '#7e22d3'
...
set yrange [0:15]
set ylabel "microseconds" textcolor rgb '#222'
set title "fib(12) benchmark" textcolor rgb '#222'
set key off
set xtics rotate by -20 textcolor rgb '#222'
set ytics textcolor rgb '#222'
set border 11 lw 1.5 lc rgb '#444'
