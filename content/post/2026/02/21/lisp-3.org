...
This is Part 3 (Lambdas) of a 3-part series.
Reading: [[file:../../../2025/11/15/lisp-1.org][Part 1 (Parsing)]] | [[file:../../../2026/01/25/lisp-2.org][Part 2 (Evaluation)]]

* Introduction

This is the third and final part of the ~Building a Lisp Interpreter (in Rust)~
series. In parts [[file:../../../2025/11/15/lisp-1.org][1]] and [[file:../../01/25/lisp-2.org][2]], we implemented the parser and ~eval~.
...
#+BEGIN_SRC dot :file env.svg :exports results
digraph {
  graph [ bgcolor=transparent, fontname="sans-serif" ];
  node [ shape=box, style=filled, fontcolor="#333", margin="0.2,0.1", penwidth=1.5 ];
  edge [ color="#a0a1a7", penwidth=1.2, fontcolor="#a0a1a7" ];
  RequestVariable -> LocalEnvironment1 -> LocalEnvironment2 -> GlobalEnvironment;
  RequestVariable [ fillcolor="#febdb2", color="#e45649", label="Request variable" ];
  LocalEnvironment1 [ fillcolor="#c1c6fb", color="#4078f2", label="Local Environment" ];
  LocalEnvironment2 [ fillcolor="#c1c6fb", color="#4078f2", label="Local Environment" ];
  GlobalEnvironment [ fillcolor="#c1c6fb", color="#4078f2", label="Global Environment" ];
}
#+END_SRC
...
#+BEGIN_SRC dot :file env2.svg :exports results
digraph {
    graph [ bgcolor=transparent, fontname="sans-serif" ];
    node [ shape=box, style=filled, fontcolor="#333", margin="0.2,0.1", penwidth=1.5 ];
    edge [ color="#a0a1a7", penwidth=1.2, fontcolor="#a0a1a7" ];
    ...
    GlobalEnvironment [ fillcolor="#c1c6fb", color="#4078f2", label="Global Environment" ];
    Env1 [ fillcolor="#c1c6fb", color="#4078f2", label="Environment: (lambda (x) ...)" ];
    Env2 [ fillcolor="#c1c6fb", color="#4078f2", label="Environment: (lambda (y) ...)" ];
}
#+END_SRC
...
scoping. However, there is a tempting mistake when implementing variable retrieval...
...
[[https://git.wmedrano.dev/wmedrano/rust-lisp-interpreter-tutorial/commits/branch/main][git.wmedrano.dev/wmedrano/rust-lisp-interpreter-tutorial]].
