...
digraph {
  ...
  node [ shape=box, style=filled, fontcolor="#222", margin="0.2,0.1" ];
  edge [ color="#444", penwidth=1.2, fontcolor="#444" ];
  RequestVariable -> LocalEnvironment1 -> LocalEnvironment2 -> GlobalEnvironment;
  RequestVariable [ fillcolor="#f0c3a0", label="Request variable" ];
  LocalEnvironment1 [ fillcolor="#9b5bd4", label="Local Environment" ];
  LocalEnvironment2 [ fillcolor="#9b5bd4", label="Local Environment" ];
  GlobalEnvironment [ fillcolor="#9b5bd4", label="Global Environment" ];
}
#+END_SRC
...
digraph {
    ...
    GlobalEnvironment [ fillcolor="#9b5bd4", label="Global Environment" ];
    Env1 [ fillcolor="#9b5bd4", label="Environment: (lambda (x) ...)" ];
    Env2 [ fillcolor="#9b5bd4", label="Environment: (lambda (y) ...)" ];
}
#+END_SRC
