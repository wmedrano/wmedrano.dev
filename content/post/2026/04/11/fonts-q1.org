...
format. Font's can make use of any assortment of the spec to accomplish the
...
digraph IFT {
  ...
  edge [color="#a0a1a7", arrowsize=0.8];

  font    [label="Font File", shape=note, fillcolor="#fafafa", color="#c18401"];
  encoder [label="IFT\nEncoder", shape=box, style="filled", fillcolor="#f3f0f7", color="#4078f2"];
  base    [label="Base Font", shape=note, fillcolor="#fafafa", color="#c18401"];
  patches [label="Patch 0|Patch 1|⋮|Patch N", shape=record, fillcolor="#fafafa", color="#c18401"];
...
digraph IFTClient {
  ...
  webpage [label="Web Page", shape=note, fillcolor="#fafafa", color="#c18401"];
  browser [label="Browser", shape=box, style="filled", fillcolor="#f3f0f7", color="#4078f2"];
  ...
  subgraph cluster_cdn {
    ...
    basefont [label="Base Font", shape=note, fillcolor="#fafafa", color="#c18401"];
    patches  [label="Patches",   shape=note, fillcolor="#fafafa", color="#c18401"];
  }
